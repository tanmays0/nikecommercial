function catalogHtml(catalogId, titleLabel) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="Shop ${titleLabel} at ARCHIVE.">
  <meta name="theme-color" content="#181510">
  <title>${titleLabel} — ARCHIVE</title>
...
<body class="page-inner" data-catalog="${catalogId}">
